  ...
  return (
    <div>
      <div className="hidden md:flex justify-between items-center w-full py-5 px-[5%] relative bg-slate-100  ">
        ...
        <div className="nav-options flex items-center gap-x-4 cart-btn">
          {isUser && user && (
          ...
          {user ? (
            <button
              ...
              className="logout-btn flex gap-x-2 items-center font-bold text-slate-100 bg-rose-500 px-7 py-[10px] rounded-sm hover:bg-slate-800"
            >
              Log out
            ...
            <>
              <Link to="/create-account">
                <button className="login-btn flex gap-x-2 items-center font-bold text-white bg-rose-500 px-7 py-[10px] rounded-sm hover:bg-slate-800">
                  Log in
                  <LuUserPlus className="text-xl font-semibold" />
                </button>
              </Link>
              <Link to="/master-admin-login">
                <button className="admin-btn flex gap-x-2 items-center font-bold text-white bg-rose-500 px-7 py-[10px] rounded-sm hover:bg-slate-800">
                  Admin Login
                  <LuUserPlus className="text-xl font-semibold" />
                </button>
              </Link>
